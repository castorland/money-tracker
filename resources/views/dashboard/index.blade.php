                                    ...
                                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                        <div class="mt-2 avatar-group">
                                            <a href="javascript:;"
                                                ...
                                                <img src="{{ asset('storage/assets/img/team-1.jpg') }}"
                                            ...
                                            <a href="javascript:;"
                                                ...
                                                data-target="tooltip_trigger" data-placement="bottom">
                                                <img src="{{ asset('storage/assets/img/team-2.jpg') }}"
                                            ...
                                            <a href="javascript:;"
                                                class="relative z-20 inline-flex items-center justify-center w-6 h-6 -ml-4 text-xs text-white transition-all duration-200 border-2 border-white border-solid rounded-full ease-soft-in-out hover:z-30"
                                                data-target="tooltip_trigger" data-placement="bottom">
                                                <img src="{{ asset('storage/assets/img/team-3.jpg') }}"
                                            ...
                                            <a href="javascript:;"
                                                class="relative z-20 inline-flex items-center justify-center w-6 h-6 -ml-4 text-xs text-white transition-all duration-200 border-2 border-white border-solid rounded-full ease-soft-in-out hover:z-30"
                                                data-target="tooltip_trigger" data-placement="bottom">
                                                <img src="{{ asset('storage/assets/img/team-4.jpg') }}"
                                ...
                                <tr>
                                    ...
                                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                        <div class="w-3/4 mx-auto">
                                            ...
                                            <div
                                                class="text-xs h-0.75 w-30 m-0 flex overflow-visible rounded-lg bg-gray-200">
                                                <div class="duration-600 ease-soft bg-gradient-to-tl from-teal-600 to-emerald-400 -mt-0.38 -ml-px flex h-1.5 w-full flex-col justify-center overflow-hidden whitespace-nowrap rounded bg-fuchsia-500 text-center text-white transition-all"
                    ...
                    <div
                        ...
                        <div class="relative mb-4 mt-0 after:clear-both after:table after:content-['']">
                            <span
                                ...
                                <i
                                    class="relative z-10 leading-none text-transparent ni ni-bell-55 leading-pro bg-gradient-to-tl from-teal-600 to-emerald-400 bg-clip-text fill-transparent"></i>
                            </span>
