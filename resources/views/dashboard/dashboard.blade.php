    ...
    <x-form-section submit="saveTransaction" class="">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-input id="name" type="text" class="mt-1 block w-full" wire:model.defer="money.amount" autofocus />
            ...
            <div class="col-span-6">
                ...
                <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <label class="flex items-center">
                        <x-checkbox wire:model.defer="money.category_id" :value="$category" />
                        <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">{{ $category }}</span>
                    </label>
