                ...
                @if ( $i < count(Request::segments()) )
                    ...
                    @if(is_numeric(Request::segment($i)))
                        <li class="text-sm leading-normal">
                            <a class="opacity-50 text-slate-700" href="{{ url($segment) }}/edit">{{ __(Str::ucfirst(Request::segment($i))) }}</a>
                        </li>
                    @else
                        <li class="text-sm leading-normal">
                            <a class="opacity-50 text-slate-700" href="{{ url($segment) }}">{{ __(Str::ucfirst(Request::segment($i))) }}</a>
                        </li>
                    @endif
                @elseif($i === count(Request::segments()) )
                    <h6 class="mb-0 font-bold capitalize">{{ __(Str::ucfirst(Request::segment($i))) }}</h6>
                @endif
            @endfor
            </ol>
        </nav>
