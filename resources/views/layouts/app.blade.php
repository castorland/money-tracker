...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- CSS Files -->
        <link rel="stylesheet" href="{{ asset('storage/assets/css/perfect-scrollbar.css') }}">
        <link rel="stylesheet" href="{{ asset('storage/assets/css/tooltips.css') }}">
        <!-- Popper -->
    ...
    <script src="{{ asset('storage/assets/js/perfect-scrollbar.js') }}"></script>
    <script src="{{ asset('storage/assets/js/tooltips.js') }}"></script>
    <script src="{{ asset('storage/assets/js/nav-pills.js') }}"></script>
    <script src="{{ asset('storage/assets/js/dropdown.js') }}"></script>
    <script src="{{ asset('storage/assets/js/fixed-plugin.js') }}"></script>
    <script src="{{ asset('storage/assets/js/sidenav-burger.js') }}"></script>
    <script src="{{ asset('storage/assets/js/navbar-sticky.js') }}"></script>
    <!-- plugin for charts  -->
    <script src="{{ asset('storage/assets/js/plugins/chartjs.min.js') }}"></script>
    <script src="{{ asset('storage/assets/js/chart-1.js') }}"></script>
    <script src="{{ asset('storage/assets/js/chart-2.js') }}"></script>
    <!-- plugin for scrollbar  -->
    <script src="{{ asset('storage/assets/js/plugins/perfect-scrollbar.min.js') }}" async></script>
    <!-- main script file  -->
