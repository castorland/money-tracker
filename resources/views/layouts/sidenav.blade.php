<aside
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors @if(request()->routeIs('transactions.index')) shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700 @endif"
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors @if(request()->routeIs('categories.index')) shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700 @endif"
